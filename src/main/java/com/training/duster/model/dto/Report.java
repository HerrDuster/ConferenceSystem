package com.training.duster.model.dto;

import java.time.LocalDateTime;
/**
 * The {@code Report} class is a data transfer object that is used to create a Report after {@link com.training.duster.model.entity.Conference}
 */
public class Report {
    private int id;
