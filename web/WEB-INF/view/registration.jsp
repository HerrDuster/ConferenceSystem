...
<jstl:if test="${not empty requestScope.user_already_exists}">
    <div class="alert alert-danger" role="alert"><fmt:message key="text.alert.user.already.exists"/></div>
</jstl:if>
<!--CONTENT-->
        ...
        <div class="container">
            <div class="signup-content">
                    ...
                    <form method="POST" class="register-form" id="register-form"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <label for="role1" style="color: #5a6268">  <fmt:message
                                        key="text.speaker"/></label>
                            </div>
                            <div class="form-group">
                                <input type="radio" name="role" id="role2" class="radio" value="USER" required/>
                                <label for="role2" style="color: #5a6268">  <fmt:message
                                        key="text.user"/></label>
                            </div>
                        <br/>
                        <%--<div class="form-group">--%>
                ...
                <div class="signup-image">
                    <figure><img src="/resources/img/signup-image.jpg" alt="sign up image"></figure>
                </div>
            </div>
        </div>
    </section>
